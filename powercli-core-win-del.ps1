...
Write-Verbose -Message "Stopping Virtual Machine with Name: [$DomainControllerVMName] on Cluster: [$TargetCluster]" -Verbose
Stop-VM -VM $DomainControllerVMName -Kill -Confirm:$false
Start-Sleep -Seconds 4
Write-Verbose -Message "Deleting Virtual Machine with Name: [$DomainControllerVMName] on Cluster: [$TargetCluster]" -Verbose
Remove-VM -VM $DomainControllerVMName -DeletePermanently -Confirm:$false
Start-Sleep -Seconds 4
Write-Verbose -Message "Virtual Machine $DomainControllerVMName Deleted." -Verbose
Start-Sleep -Seconds 1

Write-Verbose -Message "Stopping Virtual Machine with Name: [$FSVMName] on Cluster: [$TargetCluster]" -Verbose
Stop-VM -VM $FSVMName -Kill -Confirm:$false
Start-Sleep -Seconds 4
Write-Verbose -Message "Deleting Virtual Machine with Name: [$FSVMName] on Cluster: [$TargetCluster]" -Verbose
Remove-VM -VM $FSVMName -DeletePermanently -Confirm:$false
Start-Sleep -Seconds 4
Write-Verbose -Message "Virtual Machine $FSVMName Deleted." -Verbose
Start-Sleep -Seconds 1
